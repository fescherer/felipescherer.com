...
import { MENU_ITEMS } from '@/lib/_felipescherer.com/data/menu-items'
import { cn } from '@/lib/clsx-tailwind-merge/cn.function'
import { ClassNameValue } from 'tailwind-merge'
import { AccordionComponent, DropdownMenuComponent } from '@/lib/_felipescherer.com/components/primitives'
