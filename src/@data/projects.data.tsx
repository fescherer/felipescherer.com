...
export async function getProjectsData(lang: Locale): Promise<IProject[]> {
  ...
  return ([
    ...
    },
    {
      id: 'portifolio-v2',
      type: TYPE_ORIGINAL,
      tags: ['portfolio', 'react', 'figma', 'javascript', 'next', 'css', 'html'],
    ...
    {
      id: 'fennec-tales-blog',
      type: TYPE_ORIGINAL,
      tags: ['fennec-tales', 'javascript', 'css', 'html', 'react', 'nextjs'],
      date: '2024-04-18T10:00:00.000Z',
      links: {
        github: `${OWNER_CONFIGS.github_profile}/fennec-tales-blog`,
        figma: '',
        site: 'https://www.fennectales.com',
      },
      images: ['overview.gif', 'thumb.webp', 'privacy-policy.webp', 'filter.webp'],
      title: t['fennec-tales-blog'].title,
      description: t['fennec-tales-blog'].description,
    },
    {
      id: 'readme-generator',
      type: TYPE_ORIGINAL,
      tags: ['readme', 'fennec-tales', 'javascript', 'css', 'html', 'react', 'nextjs'],
      date: '2024-02-19T10:00:00.000Z',
      links: {
        github: `${OWNER_CONFIGS.github_profile}/readme-generator`,
        figma: '',
        site: 'https://www.readme.fennectales.com',
      },
      images: ['overview.gif', 'thumb.webp'],
      title: t['readme-generator'].title,
      description: t['readme-generator'].description,
    },
    {
      id: 'game-off-2023',
      type: TYPE_ORIGINAL,
      tags: ['game-off', 'fennec-tales', 'game', 'godot'],
      date: '2023-11-01T10:00:00.000Z',
      links: {
        github: `${OWNER_CONFIGS.github_profile}/game-off-2023`,
        figma: '',
        site: 'https://drafonf.itch.io/enchanted-towers-realm-defenders',
      },
      images: ['overview.gif', 'thumb.webp'],
      title: t['game-off-2023'].title,
      description: t['game-off-2023'].description,
    },
    {
      id: 'services',
      type: TYPE_ORIGINAL,
      ...
      links: {
        github: `${OWNER_CONFIGS.github_profile}/services`,
        figma: '',
        site: 'https://services.fennectales.com',
      },
      images: ['overview.gif', 'thumb.webp'],
    ...
    },
    {
      id: 'game-off-2024',
      type: TYPE_ORIGINAL,
      tags: ['game-off', 'fennec-tales', 'game', 'unreal'],
      date: '2024-11-01T10:00:00.000Z',
      links: {
        github: `${OWNER_CONFIGS.github_profile}/game-off-2024`,
        figma: '',
        site: 'https://drafonf.itch.io/mystic-cauldron',
      },
      images: ['logo.webp', 'thumb.webp'],
      title: t['game-off-2024'].title,
      description: t['game-off-2024'].description,
    },
    {
      id: 'restaurant-menu',
      type: TYPE_ORIGINAL,
      tags: ['javascript', 'css', 'html', 'react', 'nextjs'],
      date: '2024-03-17T10:00:00.000Z',
      links: {
        github: `${OWNER_CONFIGS.github_profile}/restaurant-menu`,
        figma: '',
        site: 'https://quiosque.felipescherer.com',
      },
      images: ['overview.gif', 'thumb.webp'],
