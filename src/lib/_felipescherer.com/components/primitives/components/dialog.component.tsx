  ...
  return (
    <DialogPrimitive.Root>
      ...
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content className={cn('fixed left-1/2 top-1/2 max-h-[85vh] w-[90vw] -translate-x-1/2 -translate-y-1/2 rounded-md bg-card border border-border p-[25px] shadow-lg focus:outline-hidden data-[state=open]:animate-contentShow overflow-auto', classContent)}>
          {children}
